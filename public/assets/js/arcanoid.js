...
// буква в массиве означает цвет кирпича
  ...
  // у нас 14 кирпичей по 55 пикселей и 13 промежутков по 4 пикселя, а общая ширина холста — 566 пикселей
  // получаем общую ширину стен: 400 - (14 * 35 + 4 * 13) = 24px. 
  ...
  function touchdown(t_brick) {
    ...
    switch(t_brick.color) {
      ...
      case "green"  : score += 20; break;
      case "orange" : score += 30; break;
      case "red"    : score += 40; 
    }
...
if (ball.y > canvas.height) {
  ...
  ball.dy = 0;
    ...
    context.fillText('Очки: ' + score, 50, 660);    
    // Затем — набранные очки      
    context.fillText('Жизни:'+ lives, 400, 660);
  }
