...
@section('content')
    ...
    <div class="container">
        @if (!Auth::guest())
            <h3 class="form-title">Форма редактирования курса</h3>
            ...
            <form action="{{route('course.update', $course->id)}}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        <textarea name="introduction" id="introduction"  rows="3" class="form-control">{{$course->introduction}}</textarea>
                        @error('introduction')
                            <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-9">
                        <textarea name="block1" id="block1"  rows="5" class="form-control">{{$course->block1}}</textarea>
                    </div>
                    ...
                    <div class="col-9">
                        <textarea name="block2" id="block2"  rows="5" class="form-control">{{$course->block2}}</textarea>
                    </div>
